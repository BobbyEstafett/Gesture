...
function init3D() {
    ...
    voronoiShaderMaterial = new THREE.ShaderMaterial({
        ...
        fragmentShader: `
            ...
            void main() {
                ...
                gl_FragColor = vec4(mix(col1, col2, deformation), 1.0);
            }
        `,
        wireframe: true
    });
    ...
    // Joints simples (points flottants)
...
function animate() {
    ...
    if (object3D) {
        ...
        object3D.rotation.y += 0.01; // Rotation constante
    }
